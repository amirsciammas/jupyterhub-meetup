...
run-local:
	docker-compose -f docker-compose.localmongo.yml up -d

tear_down: 
	docker-compose down || true 

build: check-files network volumes pull
	docker-compose build --no-cache

recreate: tear_down build run

build-local: check-files network volumes pull
	docker-compose -f docker-compose.localmongo.yml build
